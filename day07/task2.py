...
root_total_size = filetree.total_size
print("Root total size:", root_total_size)
free = total_size - root_total_size
print("Free space: %d" %(free))
to_free = required - free
print("To free: %d" %(to_free))

search_result = {'size': None, 'path': None}
filetree.find_to_delete(to_free, search_result)
